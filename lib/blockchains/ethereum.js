 ...
 * @todo Implement block scan for Ethereum
 * @function scanBlocks
...
function scanBlocks(firstBlock, lastBlock, callback) {
    ...
    return callback(new ProcessingError('Block scan not implemented for the Ethereum blockchain', null, 'WF_API_NOT_IMPLEMENTED'));
}
