...
const { hexToBase64u, base64uToBuffer } = require('../_common/encoding');
...
function verifySignature(wfSignDecoded, fnlPublicKey, callback) {
    const input = jws.extractSignInput(wfSignDecoded);
    const signature = base64uToBuffer(wfSignDecoded.signature);
