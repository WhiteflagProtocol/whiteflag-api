...
module.exports = {
    ...
    updateUxtos: updateAccountUtxos,
 ...
 * @alias module:lib/blockchains/bitcoin/accounts.updateUxtos
 ...
 * @function processBlockUxtos
 * @alias module:lib/blockchains/bitcoin/accounts.processBlockUxtos
 * @param {number} blockNumber the blocknumer
 * @param {Object} block the full block including transactions
 */
function processBlockUxtos(blockNumber, block) {
