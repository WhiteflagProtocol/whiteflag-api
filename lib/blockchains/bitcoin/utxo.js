 ...
 * @summary Whiteflag API Bitcoin UXTO module
...
/**
 * Sets required parameters for Bitcoin UXTO module
 * @param {*} network
 */
function setParameters(network) {
    _network = network;
}
...
function signTransaction(account, tx) {
    let privateKey = bitcoin.ECPair.fromWif(account.wif, _network);
