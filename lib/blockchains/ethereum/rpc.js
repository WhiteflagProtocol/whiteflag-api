...
function getBalance(address) {
    return timeoutPromise(_web3.eth.getBalance(withHexPrefix(address)), _rpcTimeout);
}
...
function getRawTransaction(transactionHash) {
    return timeoutPromise(_web3.eth.getTransaction(withHexPrefix(transactionHash)), _rpcTimeout);
}
...
function getTransactionCount(address) {
    return timeoutPromise(_web3.eth.getTransactionCount(withHexPrefix(address)), _rpcTimeout);
}
...
function getTransactionReceipt(transactionHash) {
    timeoutPromise(_web3.eth.getTransactionReceipt(withHexPrefix(transactionHash)), _rpcTimeout);
}
