...
const { getFullURL } = require('../common/rpc');
...
function initRpc(ethConfig, ethState) {
    ...
    const rpcAuthURL = getFullURL(ethConfig, false, DEFAULTPORT);   // include credentials
    const rpcCleanURL = getFullURL(ethConfig, true, DEFAULTPORT);   // no credentials
