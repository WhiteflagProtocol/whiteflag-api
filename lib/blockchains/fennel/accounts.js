...
/**
 * Signs an arbitrary payload with an account's private key 
 * @param {string} address the address of the account used to sign
 * @param {string} payload the hexadecimal encoded payload to be signed 
 * @return {Promise} resolves to the hexadecimal encoded signature
 */
function signPayload(account, payload, callback) {
