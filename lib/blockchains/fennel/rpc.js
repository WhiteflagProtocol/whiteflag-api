        ...
        switch (fennelConfig.rpcProtocol) {
            ...
            case 'wss': {
                ...
                .catch(err => {
                    ...
                    return reject(new Error(`Could not make a web socket connection with Fennel node: ${err.message}`), _blockchainName);
                });
                break;
            }
            // Connect via http
            ...
            // Unknown protocol
            default: {
                return reject(new Error(`Unknown protocol to connect with Fennel node: ${fennelConfig.rpcProtocol}`), _blockchainName);
            }
        }
    });
}
