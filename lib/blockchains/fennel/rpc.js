...
*/
function getRuntimeVersion() {
   if (_websocket) return Promise.resolve(Object.fromEntries(_fennelApi.rpc.state.getRuntimeVersion));
 ...
 */
function getSystemHealth() {
    if (_websocket) return Promise.resolve(Object.fromEntries(_fennelApi.rpc.system.health));
 ...
 */
function getSyncState() {
    if (_websocket) return Promise.resolve(Object.fromEntries(_fennelApi.rpc.system.syncState));
...
function getBlockHeader(blockHash) {
    if (_websocket) return Promise.resolve(Object.fromEntries(_fennelApi.rpc.chain.getHeader(blockHash)));
...
function getFullBlock(blockHash) {
    if (_websocket) return Promise.resolve(Object.fromEntries(_fennelApi.rpc.chain.getBlock(blockHash)));
