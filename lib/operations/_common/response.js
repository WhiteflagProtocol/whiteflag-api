 ...
 * @param {string} [blockchain] the name of the related blcockahin
 * @param {string} [account] the address of the related account
 * @param {string} [originator] the address of the related originator
 * @param {Object} [resMeta] the meta data object to add related resources to
 * @returns {Object} the updated meta data object
 */
