 ...
 * @alias module:lib/_common/logger.redirectStream
 ...
 * @alias module:lib/_common/logger.setLogLevel
 ...
 * @alias module:lib/_common/logger.getLogLevel
 * @param {genericCb} callback
 */
 ...
 * @function fatal
 * @alias module:lib/_common/logger.fatal
 ...
 * @function error
 * @alias module:lib/_common/logger.error
 * @param {string} module name of the module that makes the log
 * @param {string} message the message to log
 */
 ...
 * @function warn
 * @alias module:lib/_common/logger.warn
 * @param {string} module name of the module that makes the log
 * @param {string} message the message to log
 */
 ...
 * @function info
 * @alias module:lib/_common/logger.info
 * @param {string} module name of the module that makes the log
 * @param {string} message the message to log
 */
 ...
 * @function debug
 * @alias module:lib/_common/logger.debug
 * @param {string} module name of the module that makes the log
 * @param {string} message the message to log
 */
 ...
 * @function trace
 * @alias module:lib/_common/logger.trace
 * @param {string} module name of the module that makes the log
 * @param {string} message the message to log
 */
