...
// Module events //
/*
 * The rx and tx events to bind handlers to incoming and outgoing message
...
/*
 * The state eventlows to bind handlers to state changes using events; this is
 * useful when a process does not only want to keep track of some data, but
