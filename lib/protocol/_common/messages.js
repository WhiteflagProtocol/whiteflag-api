...
/* Module constants */
const wfSpec = JSON.parse(fs.readFileSync('./static/protocol/message.schema.json')).specifications;

/* MAIN MODULE FUNCTIONS */
/**
 * Determines type of message
 * @function messageType
 * @alias module:lib/_common/messages.messageType
 ...
 * @function messageType
 * @alias module:lib/_common/messages.messageTitle
 * @param {wfMessage} wfMessage a Whiteflag message
 ...
 * @alias module:lib/_common/messages.messageDescription
 * @param {wfMessage} wfMessage a Whiteflag message
 ...
 * @alias module:lib/_common/messages.messageSpecification
 * @param {wfMessage} wfMessage a Whiteflag message
...
function messageSpecification(wfMessage) {
    ...
    return wfSpec.MessageCode.find(
